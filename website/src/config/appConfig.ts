/**
 * REDLER Platform Configuration
 * 
 * Centralized configuration for the REDLER website and caregiver portal.
...
// e.g., "https://github.com/your-org/dementia/releases/download/v1.0.0/redler-release.apk"
...
export const APP_CONFIG = {
  name: "REDLER",
  tagline: "Technology that supports cognitive well-being.",
  subTagline: "Redler helps older adults stay engaged, independent and supported every day.",
  version: "v1.0.0 (Release Build)",
  targetOS: "Android 8.0+",
  buildFormat: "Universal APK",
  offlineReady: true,
  engine: "Godot Engine 4.x (GDScript)",
  regionFocus: "Designed with communities in North-East India in mind",
  supportContact: "support@redler-care.org",
  adaptiveAIEngine: "3-Tier Adaptive Difficulty Engine",
};
